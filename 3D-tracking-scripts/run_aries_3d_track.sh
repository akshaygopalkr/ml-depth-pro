...
do  
    ...
    aries run ag-${JOB}-${job_index} -j 1 -g 1 lingzhan/openvla -- bash -c "nvidia-smi && git clone https://github.com/akshaygopalkr/ml-depth-pro.git && cd ml-depth-pro && ${INSTALL} && ${RUN} ${start} ${end} ${job_index}"
done